...
```
127.0.0.1 openacademy-local-web
127.0.0.1 openacademy-local-webgateway
127.0.0.1 openacademy-local-authserver
```
...
Now, you can browse the URL: `https://openacademy-local-web`
